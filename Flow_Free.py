...
class DotGraph:
    ...
    def display(self):
        pygame.init()
        cell_size = 50
        width, height = self.size * cell_size, self.size * cell_size
        screen = pygame.display.set_mode((width, height))
        pygame.display.set_caption("Dot Graph Solver")
        ...
        def draw_dots():
            for dot in self.mat.flat:
                ...
                if dot.is_dot:
                    pygame.draw.circle(
                        screen, colors["black"], rect.center, cell_size // 4
                    )
...
#     "yellow": [(4, 0), (4, 6)],
#     "cyan": [(5, 0), (5, 6)],
#     "light_yellow": [(6, 0), (6, 6)],
# }

# Create and solve the DotGraph
dot_graph = DotGraph(6, input_data)
dot_graph.show_solve_show()
dot_graph.display()
